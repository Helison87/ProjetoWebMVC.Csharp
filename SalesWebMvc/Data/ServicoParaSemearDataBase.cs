...
{
    public class ServicoParaSemearDataBase
    {
        private SalesWebMvcContext _context;

        public ServicoParaSemearDataBase(SalesWebMvcContext context)
        {
            _context = context;
        }
        ...
        public void Semear()
        {
            ...
            Vendedor v4 = new Vendedor(4, "Marta Red", "marta@gmail.com", new DateTime(1993, 11, 20), 3000.0, d4);
            Vendedor v5 = new Vendedor(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Vendedor v6 = new Vendedor(6, "Alex black", "alexB@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
